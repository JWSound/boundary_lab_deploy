...
import boundary_deploy.solve as deploy_solve_module
from boundary_deploy.assets import DeploySolveCache
from boundary_deploy.geometry import minimum_surface_distance, surface_face_pairs_within
...
PACKAGE_PATH = Path(__file__).parents[1] / "desktop" / "library" / "S218BP_LOD.blabsp"
RIGID_MESH_PATH = Path(__file__).parents[1] / "desktop" / "library" / "RigidStage_LOD.msh"
