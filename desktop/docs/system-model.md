...
[Physical System Model](https://github.com/JWSound/boundary-lab/blob/main/docs/Physical%20System%20Model.md),
[Model Assumptions](https://github.com/JWSound/boundary-lab/blob/main/docs/Model%20Assumptions.md),
[BEAT Engine Core](https://github.com/JWSound/boundary-lab/blob/main/docs/advanced/beat-engine-core.md), and
[Coupled Solver](https://github.com/JWSound/boundary-lab/blob/main/docs/Coupled%20Solver.md) for the underlying formulations.
...
See [Inputs and Outputs](https://github.com/JWSound/boundary-lab/blob/main/docs/Inputs%20and%20Outputs.md) for archive and
...
quadrature, use [BEAT Engine Core](https://github.com/JWSound/boundary-lab/blob/main/docs/advanced/beat-engine-core.md) and
[CUDA implementation](https://github.com/JWSound/boundary-lab/blob/main/docs/advanced/beat-engine-CUDA.md).
...
[Interior FEM Solver](https://github.com/JWSound/boundary-lab/blob/main/docs/advanced/Interior%20FEM%20Solver.md) and
[Coupled Solver](https://github.com/JWSound/boundary-lab/blob/main/docs/Coupled%20Solver.md) for model construction.
...
- [Request preparation](../../src/boundary_deploy/solve.py), [package cache](../../src/boundary_deploy/assets.py), [streaming worker](../../src/boundary_deploy/worker.py).
...
- [Acoustic postprocessing](../../src/boundary_deploy/acoustic_loading.py), [electrical postprocessing/UI](../src/App.tsx), [captures](../src/model/analysisCapture.ts).
...
[CLI workflow](https://github.com/JWSound/boundary-lab/blob/main/docs/advanced/cli-workflow.md).
